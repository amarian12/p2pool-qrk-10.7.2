...
from p2pool.quark import data, networks
...
class Test(unittest.TestCase):
    ...
    def test_address_to_pubkey_hash(self):
        assert data.address_to_pubkey_hash('1KUCp7YP5FP8ViRxhfszSUJCTAajK6viGy', networks.nets['quark']) == pack.IntType(160).unpack('ca975b00a8c203b8692f5a18d92dc5c2d2ebc57b'.decode('hex'))
