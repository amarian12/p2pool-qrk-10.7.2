...
from p2pool.quark import getwork, data as quark_data
    ...
    def test_all(self):
        cases = [
            {
                ...
                'data': ''
            },
            {
        ...
        case2s = [
            getwork.BlockAttempt(
                ...
                1305759879,
                quark_data.FloatingInteger.from_target_upper_bound(0x44b9f20000000000000000000000000000000000000000000000),
